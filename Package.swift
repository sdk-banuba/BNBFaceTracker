...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.15.1-1-g11945c35fb/BNBFaceTracker.zip",
            checksum: "c896d4011a5ffce6569a4f534f6235bf6b12082d1f998184438469c4fb789482"
        ),
        .target(
