...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.3-43-gc75a0b291/BNBFaceTracker.zip",
            checksum: "1cffc8002b147d7cd81ae95d31cc5513ac851e8056155ce449c2389ca57f82a6"
        ),
        .target(
