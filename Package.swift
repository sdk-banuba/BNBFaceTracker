...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-162-gcda6b9c4b/BNBFaceTracker.zip",
            checksum: "343bf8933da3078567e881d489812110517b6e0ddfef3fe459b70f60eef8dc6e"
        ),
        .target(
