...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.9.1-69-g431d04ab4a/BNBFaceTracker.zip",
            checksum: "9ac0803d753f00af13146bb6722ce26bfde9fa13c1c87198b45b72933907f56c"
        ),
        .target(
