...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.12.1-40-gb99e5d381/BNBFaceTracker.zip",
            checksum: "4cf28b525f0f10e8ccd304532730bd5669fcb6ac0e8a45f2d3139ed906cc20fb"
        ),
        .target(
