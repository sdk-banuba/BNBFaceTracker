...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-70-g9f1f1a3b1/BNBFaceTracker.zip",
            checksum: "6c6c78bccbad54c8b6b2929cc7230d5e3184ba321e1223ffad4f7525e149cc09"
        ),
        .target(
