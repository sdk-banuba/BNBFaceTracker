...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-242-g622cf17fa4/BNBFaceTracker.zip",
            checksum: "ddce93194a393ef6263df7545c8002ca75568c5920920bc04d54164f3e77c808"
        ),
        .target(
