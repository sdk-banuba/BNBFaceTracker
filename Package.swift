...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-68-g8184560bc/BNBFaceTracker.zip",
            checksum: "1f50ca61387d3dd2ec5883da21d8217d6181881c19789429d43dc24a269261cc"
        ),
        .target(
