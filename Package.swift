...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-204-g6de1b78ed5/BNBFaceTracker.zip",
            checksum: "c316afb07145658e4dd8f10b0f827fb4b28d0870730b96f50c83c8dc409a9cb6"
        ),
        .target(
