...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-138-g40eb4c9af/BNBFaceTracker.zip",
            checksum: "71743f8f90ce1ca21ff59f9fc3f175d7c0e8cd3ef4a44f649b10af813ab88596"
        ),
        .target(
