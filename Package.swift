...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-150-gd7caecfaf/BNBFaceTracker.zip",
            checksum: "b039896c282a74fd150a0592021dfc3599eef06d7af7f021bdb7e9edab35b370"
        ),
        .target(
