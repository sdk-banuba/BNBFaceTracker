...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-203-g079acbf0ae/BNBFaceTracker.zip",
            checksum: "3636e4c37c3f8fa93c712ba74ce0323258e1bb592e3145cdab8376999c6e0289"
        ),
        .target(
