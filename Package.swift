...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.9.4-99-gef5d08583/BNBFaceTracker.zip",
            checksum: "b89694a1b367a7864871ab1492a5bc93775b779b66518d4502aa8687b68189d5"
        ),
        .target(
