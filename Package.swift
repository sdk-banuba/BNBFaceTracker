...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-188-g3e9bf00b67/BNBFaceTracker.zip",
            checksum: "ec73800e09c0083f928d55436e2759af11437334eaa2c3e11e490d7b11847e47"
        ),
        .target(
