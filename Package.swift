...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.13.2-44-g649e5173b/BNBFaceTracker.zip",
            checksum: "809723a540d1a9a685b607b64c2be0e4f5a84f65f0c9d426753ef3a8f9232750"
        ),
        .target(
