...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-177-gd98bf09f0/BNBFaceTracker.zip",
            checksum: "72a3996e267fbecd3970c73d005f483524b3d769e1f08d5c2bfe85738d0879eb"
        ),
        .target(
