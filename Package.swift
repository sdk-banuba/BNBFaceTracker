...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-199-g2f4e3cf953/BNBFaceTracker.zip",
            checksum: "7464488edcc809217f7cf5754889e1b9a8ce1b6d5763df1e2dac84e9bf118fa7"
        ),
        .target(
