...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-33-gdff1aad66/BNBFaceTracker.zip",
            checksum: "f53aed1a990b4799525152142e1c301465bcf3d157df0ddaddc2d87995850f32"
        ),
        .target(
