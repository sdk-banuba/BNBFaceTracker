...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-75-g381c51d93/BNBFaceTracker.zip",
            checksum: "0f52c313b4440b71b2474f99ccd57fac28bcf517ba466e3fc087bdabecb782c6"
        ),
        .target(
