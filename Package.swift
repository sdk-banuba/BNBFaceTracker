...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-61-gc1c7cef54/BNBFaceTracker.zip",
            checksum: "fa26dfaffb02c7cf2177d986e32e0f02158a9c113837ae5554837b5a4704ee22"
        ),
        .target(
