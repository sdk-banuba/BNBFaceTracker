...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.13.0-1-g971efc62f/BNBFaceTracker.zip",
            checksum: "81cef1747904b0ac02c59450d5d58a43e4e74bf8d74c34718fac1404feeb14f4"
        ),
        .target(
