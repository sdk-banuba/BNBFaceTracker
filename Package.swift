...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.0-3-gb365c1950/BNBFaceTracker.zip",
            checksum: "79da0402a8defdbe9b9ccea7eae041e3473d89b9ae5b5942f06883581f2176c7"
        ),
        .target(
