...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-218-g91528edbf1/BNBFaceTracker.zip",
            checksum: "95a26bdebeef2807e74d3b0104a882c9cd560abb5da59f48f03e8c566b05376d"
        ),
        .target(
