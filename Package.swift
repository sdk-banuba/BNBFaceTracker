...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-215-g9f21b13b23/BNBFaceTracker.zip",
            checksum: "6f899ebd4cde06e88ef016e585cfb1f15835af83b9684e4d31599a160c73ac2b"
        ),
        .target(
