...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-143-g50b5f987b/BNBFaceTracker.zip",
            checksum: "8ae9efff95906b9894d79db5858e5ba0a10a19b89d48f294506a72eef77721e9"
        ),
        .target(
