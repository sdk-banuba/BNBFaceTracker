...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-67-g77a5e386d/BNBFaceTracker.zip",
            checksum: "b08671cbbb5bf299163eb6ed5cc6a073b8a40dd0eefba59b1ce81e09dfa4b752"
        ),
        .target(
