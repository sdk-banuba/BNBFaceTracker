...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-183-gf9e3d7354f/BNBFaceTracker.zip",
            checksum: "9cd14842b62bbf6287dcdb653fb0bc3eaf82c5227b73df6cf065a93875cad58a"
        ),
        .target(
