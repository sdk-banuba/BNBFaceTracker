...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-173-gee6f2723a/BNBFaceTracker.zip",
            checksum: "8aebf098639cc7ca3fe1b0ddedaf1598274b43e11a281a1502c5cc2af43755d7"
        ),
        .target(
