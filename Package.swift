...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-174-gec051bdc7/BNBFaceTracker.zip",
            checksum: "8c4cb61c77b573f4e06fa50847f34bccbd5e7e37e8c95b708fb57080f416b2a0"
        ),
        .target(
