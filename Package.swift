...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-203-g2a72d3010f/BNBFaceTracker.zip",
            checksum: "bfbc37a92bc417fcd654f95b4ed4f7cc7471521d47718aa878127817b51f52c9"
        ),
        .target(
