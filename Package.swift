...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.12.1-33-g6de24312a/BNBFaceTracker.zip",
            checksum: "9047c60758db3cab8511273355e5a713a323ca24fb59d709dad415bb186c8dab"
        ),
        .target(
