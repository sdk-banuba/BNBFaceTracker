...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-137-gc11b2b754/BNBFaceTracker.zip",
            checksum: "d9c05d8b59f2ab3dc1d9697738e9b6c67e927eede7c9d5887d806c323d28477a"
        ),
        .target(
