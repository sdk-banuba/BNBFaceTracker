...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-146-g6f441498b/BNBFaceTracker.zip",
            checksum: "9dbdb57e09c34cbb4c0168dad6b6bd4155d8697cea4ad90525839fb7fab9044f"
        ),
        .target(
