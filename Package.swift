...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.18.0-8-g22fe376040/BNBFaceTracker.zip",
            checksum: "158db57e77e1268d339027825cc7ca416d1cd836fdb391f2f55524db2496f8a4"
        ),
        .target(
