...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-53-g189d46433/BNBFaceTracker.zip",
            checksum: "d160827b6a7be294b8c3dd09ba2e52bfc3068a05f2e870b10e15d289e9059e25"
        ),
        .target(
