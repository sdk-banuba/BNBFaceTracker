...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-185-gf41e807277/BNBFaceTracker.zip",
            checksum: "b65f7cdc2016c5df4ddb9b3085aad8a5c69f33c4c80b4fbb128e77fc6d77b360"
        ),
        .target(
