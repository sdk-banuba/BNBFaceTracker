...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-178-gf86664003c/BNBFaceTracker.zip",
            checksum: "80eca86741b24b00e769aaf44e103d830f5652e367344b085d8442d5182af110"
        ),
        .target(
