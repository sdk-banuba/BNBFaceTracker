...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-170-g91aac4bda/BNBFaceTracker.zip",
            checksum: "cb7be698fdec82ef087af978f511fe80ddfbe4592fd036e07a08e9a3d87a7f1a"
        ),
        .target(
