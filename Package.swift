...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-70-g2e0f1ab74/BNBFaceTracker.zip",
            checksum: "7216d8e8ad09efe9df9a3f0a958df323412dde753e22570323f3eff32a220f0f"
        ),
        .target(
