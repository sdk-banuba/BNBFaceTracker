...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.18.2-24-g50ecbc89fd/BNBFaceTracker.zip",
            checksum: "0f26463eab6441d35fded62483d9489cbba4d9f81878e263b9fdc3fc70b6710c"
        ),
        .target(
