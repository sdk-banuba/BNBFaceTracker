...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.12.1-35-g200bb3db4/BNBFaceTracker.zip",
            checksum: "c628ad0bd26b11c77a7568e6daaabec5f4fe17eb974b966dd1426872e07b644b"
        ),
        .target(
