...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-132-g6a6b08380/BNBFaceTracker.zip",
            checksum: "fbcb8eb716d6ad14e9af1a4483fdd3260ff5128f3038484be86e5686301bdf2e"
        ),
        .target(
