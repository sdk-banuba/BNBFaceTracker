...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.9.1-86-g65c1c833d4/BNBFaceTracker.zip",
            checksum: "daa323eb7acfbe3d3fbc0de6463f0d9cfe5bd22e605285786e5ce3152826e978"
        ),
        .target(
