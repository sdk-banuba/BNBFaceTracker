...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-216-gc859e59035/BNBFaceTracker.zip",
            checksum: "1293d01779897ade3d31f7fc70ed6b224065af67575421e8d8dab3f5bfcba95f"
        ),
        .target(
