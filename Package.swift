...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-184-gfc3672a53b/BNBFaceTracker.zip",
            checksum: "1e1f02b58c41a2c79db7fac23fd2f5b06b6ba37d63fe557ba89ac3a5d647a80e"
        ),
        .target(
