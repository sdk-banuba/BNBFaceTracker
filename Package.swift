...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-180-gd5fc258816/BNBFaceTracker.zip",
            checksum: "e179ec3c75def2836f80b56de62b73e0771ca5edd881b7c7bc28a8f433727ce4"
        ),
        .target(
