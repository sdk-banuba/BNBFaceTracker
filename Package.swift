...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-4-g0bf2ba10e/BNBFaceTracker.zip",
            checksum: "7886a22704f52695d27c5f13202781ddcd9a99202de7b00f8208044d787e4a64"
        ),
        .target(
