...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-124-gbdb47c5e3/BNBFaceTracker.zip",
            checksum: "ab274d4c1be241f5a37dfe12df38a9f2b677baf99ffb5db25cbb3f7dcfa207ae"
        ),
        .target(
