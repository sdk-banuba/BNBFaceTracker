...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-211-g9b253c9f0f/BNBFaceTracker.zip",
            checksum: "af143722522978f71ce8b8495829d1b923d80e1a668cd5bc9db018d1b0633321"
        ),
        .target(
