...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.10.0-24-gb831098a87/BNBFaceTracker.zip",
            checksum: "6835fc7c07af5bdd5b7a029bb1d7161a50203fb4bff840c366ebd72a6b3eb949"
        ),
        .target(
