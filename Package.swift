...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-187-g0f5dcf5d80/BNBFaceTracker.zip",
            checksum: "d0afa7de618cc02ec09c17ab3e018587bd719183f6a0cb47ef998bca2e415d85"
        ),
        .target(
