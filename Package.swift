...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-162-g26e50cae8/BNBFaceTracker.zip",
            checksum: "4c586b056e30f14fc8d502537c8d93d61bb3262979f4d593fc170f631f1d5b94"
        ),
        .target(
