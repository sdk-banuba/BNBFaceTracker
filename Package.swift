...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-186-g71865c20be/BNBFaceTracker.zip",
            checksum: "14b282230c4f3a55f642a9c6f3d8f940f46bc7d7302669219a5d4cb2213d65f3"
        ),
        .target(
