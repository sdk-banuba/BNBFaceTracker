...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-184-gd8cb662170/BNBFaceTracker.zip",
            checksum: "45c78ba54348c5879cf857766fca2ea7003c11203cc9daaf51a258c36620f1bc"
        ),
        .target(
