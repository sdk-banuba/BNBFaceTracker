...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.10.1-73-g8d138045c3/BNBFaceTracker.zip",
            checksum: "05a50a20b65969023d949705575713ef21668060cebb9ef258201f529e924dea"
        ),
        .target(
