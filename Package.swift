...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.10.0-19-gb88228b6f/BNBFaceTracker.zip",
            checksum: "2b62935c8c46c0e11b0cae4727e42a560082a599e836f1f8b15fc475841798c3"
        ),
        .target(
