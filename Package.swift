...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-71-g826381c83/BNBFaceTracker.zip",
            checksum: "5dd962d2fb3df4d8ed98db47eb65f5148117ba210963a413e886b3dccee6f709"
        ),
        .target(
