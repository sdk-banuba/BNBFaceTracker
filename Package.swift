...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-55-g4d630007f/BNBFaceTracker.zip",
            checksum: "fbabd5d3bf2b5bafd9fa63c5ca2fb0bc439b1c9fb79fcc0c925bb6a265b41c2b"
        ),
        .target(
