...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.17.1-32-gc91d258b34/BNBFaceTracker.zip",
            checksum: "8ccb348cfaf815a1f2da3cfa66bdf41e7917eb49bfc15ebaa3ffc640c6e84858"
        ),
        .target(
