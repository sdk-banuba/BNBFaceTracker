...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.17.0-33-g2b785861d0/BNBFaceTracker.zip",
            checksum: "d0c3aa520315457eb9d51c74110a295f9c2c30f5b2c12b37efc3c0e49c74bbaa"
        ),
        .target(
