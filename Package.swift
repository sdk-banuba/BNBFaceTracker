...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.0-9-g9cd2ba648/BNBFaceTracker.zip",
            checksum: "d498a2c64bdf47fe1427be17e3227c23a6700144cc24128e7837832c3943145f"
        ),
        .target(
